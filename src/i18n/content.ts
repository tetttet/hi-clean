    ...
    cleaningDurations: [
      {
        ...
        label: "Standart",
        hours: "Normal fiyat",
        description: "Standart ekip planı.",
        multiplier: 1,
      },
      {
        id: "fast-30",
        label: "30% daha hızlı",
        hours: "+30% fiyat",
        description: "Daha hızlı ekip planı.",
        multiplier: 1.3,
      },
    ],
    paymentMethods: [
    ...
    cleaningDurations: [
      {
        ...
        label: "Стандарт",
        hours: "Обычная цена",
        description: "Стандартный план команды.",
        multiplier: 1,
      },
      {
        id: "fast-30",
        label: "На 30% быстрее",
        hours: "+30% к цене",
        description: "Более быстрый план команды.",
        multiplier: 1.3,
      },
    ],
    paymentMethods: [
    ...
    cleaningDurations: [
      {
        ...
        label: "Standard",
        hours: "Regular price",
        description: "Standard team plan.",
        multiplier: 1,
      },
      {
        id: "fast-30",
...
const servicesUi: Record<Locale, ServicesPageUi> = {
  ...
  ru: {
    ...
    validation: {
      ...
      durationRequired: "Выберите скорость.",
  ...
  en: {
    ...
    validation: {
      ...
      durationRequired: "Choose a speed.",
